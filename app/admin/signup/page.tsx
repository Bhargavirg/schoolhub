...
export default function AdminSignUp() {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-r from-purple-400 via-pink-500 to-red-500 flex items-center justify-center p-4 sm:p-8">
      <div className="bg-white bg-opacity-90 rounded-xl shadow-lg p-4 sm:p-8 w-full max-w-md">
        <h1 className="text-2xl sm:text-3xl font-bold mb-6 text-center text-purple-700">Admin Sign Up</h1>
